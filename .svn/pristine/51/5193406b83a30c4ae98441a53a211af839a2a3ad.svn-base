    ...
    function(a) {
        a.fn.jalendar = function(t) {
            ...
            l.EN = new Array("Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"),
                ...
                o.CH = new Array("一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"),
                f.EN = "Add New Event",
                ...
                p.CH = "Total Events in This Month: ",
                h.EN = "Event(s)",
                h.TR = "Etkinlik",
                h.ES = "Evento(s)",
                h.CH = "Event(s)",
